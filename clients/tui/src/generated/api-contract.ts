...
export const DAEMON_API_CONTRACT = {
  ...
  endpoints: [
    ...
    },
    {
      ...
      method: "POST",
      route_pattern: "/api/v1/connections/{profile_id}/credential/login/browser/start",
      path_params: ["profile_id"],
      area: "connections",
      remote_scope: "host.auth.write",
      relay: {
    ...
    },
    {
      ...
      method: "POST",
      route_pattern: "/api/v1/connections/{profile_id}/credential/login/device/start",
      path_params: ["profile_id"],
      area: "connections",
      remote_scope: "host.auth.write",
      relay: {
    ...
    },
    {
      ...
      method: "POST",
      route_pattern: "/api/v1/connections/{profile_id}/credential/login/device/complete",
      path_params: ["profile_id"],
      area: "connections",
      remote_scope: "host.auth.write",
      relay: {
    ...
    },
    {
      ...
      method: "POST",
      route_pattern: "/api/v1/sessions/{id}/child_runs/{child_run_id}/terminate",
      path_params: ["id", "child_run_id"],
      area: "sessions",
      remote_scope: "session.admin",
      relay: {
